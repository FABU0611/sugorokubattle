		...
		for (int i = 0; i < 10; i++)
		{
			if (Light.Flags[i].y == 1)
			{
				if (Light.Flags[i].x == 1)
				{
                    ...
                    color = saturate(inDiffuse * Material.Diffuse * light * Light.Diffuse[i]);
                    color = saturate(color + inDiffuse * Material.Ambient * Light.Ambient[i]);
                }
                ...
                outColor = saturate(outColor + color);
            }
		}
