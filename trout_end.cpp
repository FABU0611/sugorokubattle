...
void TROUT_END::Init(void)
{
	...
	{//頂点バッファの中身を埋める
		...
		// UV値の設定
		pVtx[0].TexCoord = D3DXVECTOR2((1.0f / 6) * 4, 0.0f);
		pVtx[1].TexCoord = D3DXVECTOR2((1.0f / 6) * 4, 1.0f);
		pVtx[2].TexCoord = D3DXVECTOR2((1.0f / 6) * 5, 0.0f);
		pVtx[3].TexCoord = D3DXVECTOR2((1.0f / 6) * 5, 1.0f);
